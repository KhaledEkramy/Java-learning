...
public class Percolation {
    ...
    public Percolation(int n) {
        ...
        this.wqufGrid = new WeightedQUPC(this.gridSize * this.gridSize + 2);
        this.wqufFull = new WeightedQUPC(this.gridSize * this.gridSize + 1);
        this.virtualTop = this.gridSize * this.gridSize;
        this.virtualBottom = this.gridSize * this.gridSize + 1;
        this.openSites = 0;
        this.neighbors = new int[][]{{0, 1}, {0, -1}, {1, 0}, {-1, 0}};
    }
